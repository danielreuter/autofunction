...
import { ExtensionFunctionType, parseFunctionDef } from "./parsers/function";
import { ExtensionVoidType, parseVoidDef } from "./parsers/void";
...
const selectParser = (
  ...
  switch (typeName) {
    ...
    case ZodFirstPartyTypeKind.ZodDate: // will need to deal with serialization issues
    ...
    case ZodFirstPartyTypeKind.ZodPromise: // should signal that it's a promise
    ...
    case ZodFirstPartyTypeKind.ZodFunction: // added
      return parseFunctionDef(def, refs);
    case ZodFirstPartyTypeKind.ZodVoid: // added
      return parseVoidDef();
